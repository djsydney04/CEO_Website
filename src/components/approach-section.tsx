export function ApproachSection() {
  return (
    <div className="mb-24">
      <h2 className="text-4xl font-bold text-black mb-6">How We Approach Entrepreneurship</h2>
      <p className="text-xl text-black mb-12 max-w-4xl font-light">
      ...
      <p className="text-xl text-black mb-12 font-light">Here's how we make it happen:</p>
      
      <div className="grid md:grid-cols-3 gap-8">
        <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-10 shadow-xl border border-black/5 transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
